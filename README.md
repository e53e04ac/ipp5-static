...
graph RL;
  ...
  click C_15 "https://github.com/e53e04ac/ipp5-types/tree/ebe99d725f05ad1eabec2b37a2c5737becc56480";
~~~~~
...
graph RL;
  ...
  subgraph "lib\time-span\base\index";
    I_0_0(["Base"]);
  end;
  subgraph "lib\time-span\hold\index";
    I_1_0(["Get"]);
    I_1_1(["ValueOrGet"]);
  end;
  M ----> I_0_0;
...
graph RL;
  ...
  subgraph "lib\time-span\base\index.js";
    I_0_0(["Base"]);
  end;
  subgraph "lib\time-span\hold\index.js";
    I_1_0(["hold"]);
    I_1_1(["unwrap"]);
  end;
  M ----> I_0_0;
